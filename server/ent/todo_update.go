...
func (_u *TodoUpdate) SetConversation(v *Conversation) *TodoUpdate {
...
func (_u *TodoUpdate) ClearConversation() *TodoUpdate {
...
// SetConversation sets the "conversation" edge to the Conversation entity.
func (_u *TodoUpdateOne) SetConversation(v *Conversation) *TodoUpdateOne {
	return _u.SetConversationID(v.ID)
}
...
// ClearConversation clears the "conversation" edge to the Conversation entity.
func (_u *TodoUpdateOne) ClearConversation() *TodoUpdateOne {
	_u.mutation.ClearConversation()
	return _u
}
